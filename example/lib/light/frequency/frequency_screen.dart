...
import '../duty_cycle/duty_cycle.dart';

// ignore: must_be_immutable
class FrequencyScreenLightOnly extends StatefulWidget {
  var device;
  final writeC;
  final readC;
  FrequencyScreenLightOnly(
      {super.key, required this.device, required this.writeC, this.readC});

  @override
  State<FrequencyScreenLightOnly> createState() =>
      _FrequencyScreenLightOnlyState();
}

class _FrequencyScreenLightOnlyState extends State<FrequencyScreenLightOnly> {
