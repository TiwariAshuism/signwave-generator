...
class DutyCycleLightOnly extends StatefulWidget {
  ...
  @override
  State<DutyCycleLightOnly> createState() => _DutyCycleLightOnlyState();
}

class _DutyCycleLightOnlyState extends State<DutyCycleLightOnly> {
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      Get.to(() => SubmissionFirstLightOnly(
